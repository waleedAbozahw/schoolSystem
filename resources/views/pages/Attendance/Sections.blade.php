...
@section('page-header')
    <!-- breadcrumb -->
<h3>{{ trans('Sections_trans.title_page') }}:{{trans('main_trans.Attendance')}}</h3>
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <label class="badge badge-{{$list_Sections->Status == 1 ? 'success':'danger'}}">{{$list_Sections->Status == 1 ? trans('main_trans.active'):trans('main_trans.not_active')}}</label>
                                                                        </td>
