...
@section('page-header')
<!-- breadcrumb -->
<h3>{{trans('main_trans.Settings')}}</h3>
                ...
                <form enctype="multipart/form-data" method="post" action="{{route('settings.update','test')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('main_trans.school_abrev_name')}}</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('main_trans.first_term_end')}} </label>
                                <div class="col-lg-9">
                                    <input name="end_first_term" value="{{ $setting['end_first_term'] }}" type="text" class="form-control date-pick" placeholder="Date Term Ends">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('main_trans.second_term_end')}}</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">{{trans('main_trans.school_label')}}</label>
                                <div class="col-lg-9">
                                    <div class="mb-3">
