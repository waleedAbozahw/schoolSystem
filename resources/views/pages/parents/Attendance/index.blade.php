    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('children_attendance_search') }}" autocomplete="off">
                    @csrf
                    <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{trans('Parent_trans.search')}}</h6><br>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="student">{{trans('Parent_trans.students')}}</label>
                                <select class="custom-select mr-sm-2" name="student_id">
                                    <option value="0">{{trans('Parent_trans.all')}}</option>
                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                        <thead>
                            <tr>
                                ...
                                <th class="alert-success">{{trans('Parent_trans.date')}}</th>
                                <th class="alert-warning">{{trans('Parent_trans.status')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($Students as $student)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="btn-danger">{{trans('Parent_trans.apsent')}}</span>
                                    @else
