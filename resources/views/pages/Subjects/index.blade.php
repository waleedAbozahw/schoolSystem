...
@section('page-header')
    <!-- breadcrumb -->
<h3> {{trans('subjects.subjects_list')}}</h3>
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->teacher->Name}}</td>
                                                <td>
                                                    <a href="{{route('subjects.edit',$subject->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="{{trans('processes.edit')}}"><i class="fa fa-edit"></i></a>
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_subject{{ $subject->id }}" title="{{trans('processes.delete')}}"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p> {{ trans('messages.Warning_Message') }} {{$subject->name}}</p>
