                    ...
                    <form action="{{route('Fees.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('main_trans.arabic_name')}}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('main_trans.english_name')}}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{trans('main_trans.classroom')}}</label>
                                <select class="custom-select mr-sm-2" name="Classroom_id">
                                    <option value="{{$fee->Classroom_id}}">{{$fee->classroom->Name_Class}}</option>
                                </select>
                            </div>
                            <div class="form-group col">
                                <label for="inputZip">{{trans('main_trans.year_study')}}</label>
