...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{trans('main_trans.edit_question')}} :<span class="text-danger">{{$question->title}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('main_trans.answers')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('main_trans.right_answer')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('main_trans.quiz_name')}} : <span
                                                    class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="quiz_id">
                                                <option selected disabled>  {{trans('main_trans.quiz_name')}}...</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Grade_id">{{trans('main_trans.degree')}} : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled>  {{trans('main_trans.degree')}}...</option>
                                ...
                                <br>
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit"> {{trans('main_trans.save_data')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
