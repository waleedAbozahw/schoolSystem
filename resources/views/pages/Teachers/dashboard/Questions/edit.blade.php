...
@section('css')
    @toastr_css
@section('title')
{{trans('Teacher_trans.edit_question')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
<h3>{{trans('Teacher_trans.edit_question')}}:<span class="text-danger">{{$question->title}}</span></h3>
<!-- breadcrumb -->
@endsection
@section('content')
    <!-- row -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('teacher_questions.update',$question->id) }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">{{trans('Teacher_trans.answers')}}</label>
