...
@toastr_css
@section('title')
{{trans('Teacher_trans.attendance_list')}}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<h3>{{trans('Teacher_trans.attendance_list')}}</h3>
<!-- breadcrumb -->
@endsection
@section('content')
<!-- row -->
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
        <thead>
            <tr>
                ...
                <th class="alert-success">{{trans('Teacher_trans.attendance')}}</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                        ...
                        <span class="text-success">{{trans('Teacher_trans.present')}}</span>
                    </label>
                    ...
                    <label class="ml-4 block text-gray-500 font-semibold">
                        ...
                        <span class="text-danger">{{trans('Teacher_trans.absent')}}</span>
                    </label>
