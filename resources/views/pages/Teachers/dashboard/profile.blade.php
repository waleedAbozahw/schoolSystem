...
@section('page-header')
    <!-- breadcrumb -->
    <h3>{{trans('Teacher_trans.profile')}}</h3>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.update',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('Teacher_trans.arabic_username')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{trans('Teacher_trans.english_username')}}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="checkbox" class="form-check-input" onclick="myFunction()"
                                               id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">{{trans('Teacher_trans.show_password')}}</label>
                                    </div>
                                </div>
                                <hr>
                                <button type="submit" class="btn btn-success">{{trans('processes.edit')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
