...
@section('css')
    @toastr_css
@section('title')
{{trans('main_trans.edit_return_money')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->

    <h3>  {{trans('main_trans.edit_return_money')}} : <label style="color: red">{{$payment_student->student->name}}</label></h3>
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('main_trans.tidysum')}} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('main_trans.notes')}} : <span class="text-danger">*</span></label>
